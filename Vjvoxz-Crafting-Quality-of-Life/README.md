...
## Table of Contents
1. [Overview](#overview)
2. [Directory Tree Hierarchy](#directory-tree-hierarchy)
3. [Custom Namespace (`custom`)](#1-custom-namespace-custom)
    * [back_to_blocks](#back_to_blocks)
    * [botanical_replication](#botanical_replication)
    * [craftable](#craftable)
    * [stonecutter](#stonecutter)
    * [universal_dyeing](#universal_dyeing)
    * [unpackable](#unpackable)
4. [Minecraft Namespace (`minecraft`)](#2-minecraft-namespace-minecraft)
5. [Recipe Distribution Summary](#recipe-distribution-summary)
...
## 2. Minecraft Namespace (`minecraft`)
