# Crafting Quality of Life: More Stairs
This file contains JSON files that define the recipes for the `more_stairs` for Minecraft Java Edition 26.3.
...
```
## Polished Blackstoone Brick Stairs
```json
{
	"type": "minecraft:crafting_shaped",
	"category": "building",
...
```json
{
	...
	"key": {
		"#": [
			"minecraft:prismarine_block",
			"minecraft:prismarine_pillar"
		]
	},
	"pattern": [
		"#  ",
