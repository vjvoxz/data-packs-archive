...
All metadata files are under [MIT License](https://github.com/vjvoxz/MIT-License) by Vjvoxz - MMXXVI.[^1]

[^1]JE-1.21.7+DP-v81 metadata are the original files from VoodooBeard
